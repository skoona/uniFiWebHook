...
esp_err_t wifi_init_sta(void) {
	...
	if (bits & WIFI_CONNECTED_BIT) {
		ESP_LOGI("Network", "connected to ap SSID:%s", EXAMPLE_ESP_WIFI_SSID);
	} else if (bits & WIFI_FAIL_BIT) {
		ESP_LOGI("Network", "Failed to connect to SSID:%s", EXAMPLE_ESP_WIFI_SSID);
	} else {
...
esp_err_t startWiFiService(void) {
	ESP_LOGI("Network", "startWiFiService(): ESP_WIFI_MODE_STA");
	// Initialize NVS
